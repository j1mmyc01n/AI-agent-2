...
import { ListTodo, CheckCircle2, Circle, Clock, SkipForward, X, ChevronDown, ChevronUp, Loader2, Brain, Code2, Sparkles, FileCode } from "lucide-react";
      ...
      <div className="p-4 space-y-4" ref={scrollRef}>
        ...
        <div className="space-y-2">
          {activeTodos.map((todo, idx) => {
            ...
            const isFileTask = todo.id.startsWith("file-");
            return (
              <div
                key={todo.id}
                data-todo-item
